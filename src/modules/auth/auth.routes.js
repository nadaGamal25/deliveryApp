...
import { allowedTo, changePassword, confirmOTP, deleteUser, forgetPassword, getAccountData, protectedRoutes, regenerateOtp, setNewPassword, signin, signout, signup, updateAccount } from './auth.controller.js'
import { changePasswordVal, confirmOtpVal, forgetPassVal, regenerateOtpVal, signinVal, signupVal, updatePassVal, updateUserVal } from './auth.validation.js'

const authRouter=express.Router()

authRouter.post('/signup',uploadMixFiles([{name:'profileImg',maxCount:1},{name:'vehiclesImgs',maxCount:4},{name:'licenseVehicleImgs',maxCount:2},
    {name:'idCardImg',maxCount:2},{name:'licenseImg',maxCount:2}],'user'),validate(signupVal),checkPhoneExist,checkEmailExist,signup)
...
uploadMixFiles([{name:'profileImg',maxCount:1},{name:'idCardImg',maxCount:2},{name:'licenseImg',maxCount:2},{name:'vehiclesImgs',maxCount:4},{name:'licenseVehicleImgs',maxCount:2}],'user'),validate(updateUserVal),updateAccount)
