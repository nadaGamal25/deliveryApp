...
import { blockUser, confirmUser, deleteUser, getClients, getOrders, getUsersOrderedOrders, highlightUser, invalidUser, updateUser, updateWallet } from './admin.controller.js'
import { allowedTo, protectedRoutes } from '../auth/auth.controller.js'
import { validate } from '../../middleware/validate.js'
import { blockUserVal, confirmUserVal, highlightUserVal, invalidUserVal } from './admin.validation.js'
