...
adminRouter.put('/update-user/:id',protectedRoutes,allowedTo('admin'),validate(updateUserVal),uploadMixFiles([{name:'profileImg',maxCount:1},{name:'vehiclesImgs',maxCount:4}],'user'), updateUser)
